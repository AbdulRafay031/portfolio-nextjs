...
const Home = () => {
  ...
  <div className='bg-primary/60 h-full'>
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 '>
      <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
        ...
        className='h1'>
          ...
          animate='show'
          exit='hidden' 
          className='max-w-sm xl:mx-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16'>
            I am Abdul Rafay i am full stack front-end-developer and also a undergraduate student
            from SMIU in BS Computer Science. 
    ...
    <div className='w-[1200px] h-full absolute right-0 bottom-0'>
      ...
      absolute mix-blend-color-dodge translate-z-50'></div>
      {/* particles */}
     <ParticlesContainer/>
